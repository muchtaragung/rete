                    ...
                    <form action="<?= site_url('admin/user/save') ?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <input type="file" name="foto" class="form-control" placeholder="Foto" id="preview_gambar" accept=".jpg,.jpeg,.png" required>
                                <img width="100%" src="" alt="" id="gambar_load" class="img-circle mt-1">
                            </div>
                            <div class="form-group col-lg-5">
                                <label for="">Telepon</label>
                                <input type="text" name="telepon" class="form-control" placeholder="0812828182" required>
                            </div>
                            <div class="form-group col-lg-5">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <textarea name="profil" id="" cols="30" rows="5" class="form-control"></textarea>
                            </div>
